...
public interface IProjetoRepository {
	...
	public abstract boolean gravaResponsaveisProjeto(Projeto projeto,
			List<Responsavel> responsaveis);

	public abstract boolean gravaResponsaveisProjeto(Projeto projeto,
			Responsavel responsavel);

	public abstract boolean gravaAtividadesProjeto(Projeto projeto,
			List<ProjetoAtividade> atividades);

	public abstract boolean gravaAtividadesProjeto(Projeto projeto,
			ProjetoAtividade atividade);

	public abstract List<ProjetoAtividade> gravaAtividade(
			List<ProjetoAtividade> projetoAtividade);

	public abstract boolean gravaCompetenciaAtividades(
			ProjetoAtividade atividade);

	public abstract boolean gravaResponsaveisAtividade(
			ProjetoAtividade atividade);

	public abstract boolean gravaResponsaveisAtividade(
			ProjetoAtividade atividade, Responsavel responsavel);

	public abstract int gravaAtividade(ProjetoAtividade atividade);

	public abstract boolean alterarProjeto(Projeto projeto);

	public abstract List<ProjetoAtividade> alterarAtividade(
			List<ProjetoAtividade> projetoAtividade);
	...
	public abstract boolean excluirResponsaveisAtividade(
			ProjetoAtividade atividade);
	...
	public abstract List<ProjetoAtividade> listarAtividadesProjeto(
			Projeto projeto);

	public abstract ProjetoAtividade recuperarAtividadeProjetoPorId(
			int idAtividade);

	public abstract Feedback recuperaFeedbackAtividade(
			ProjetoAtividade atividade);

	public abstract Projeto recuperarProjetoPorAtividade(
			ProjetoAtividade atividade);

	public abstract List<Responsavel> listarResponsaveisProjeto(Projeto projeto);

	public abstract List<Competencia> listarCompetenciasProjetoAtividade(
			ProjetoAtividade atividade);
