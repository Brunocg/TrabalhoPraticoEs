...
folder are mapped to the application's root namespace, 'TrabalhoPraticoEsApp'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "TrabalhoPraticoEsApp"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'TrabalhoPraticoEsApp' in the same way
as `"TrabalhoPraticoEsApp/sass/src"`.
